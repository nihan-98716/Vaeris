-- Vaeris Database Schema Initialization
...
-- Spatial index for nearest-station or radius calculations
...
-- Indexes for time range filtering and join lookups
...
-- Spatial and temporal indexes for wind vector intersection queries
...
-- Spatial and temporal indexes for wind flow maps
...
-- 5. OSM Road Cache Table (Caching for Road Density)
