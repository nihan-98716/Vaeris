...
def optimize_interventions(
    ...
    filtered = [
        dict(i) for i in INTERVENTION_CATALOG
    ...
    for i in filtered:
        i["health_benefit"] = calculate_health_benefit(i["aqi_reduction"], i["population_affected"])
    ...
    for candidate in sorted_candidates:
        ...
        if (current_cost + cost <= budget) and (current_inspectors + req_inspectors <= inspectors):
